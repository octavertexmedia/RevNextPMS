...
PRODUCT_HOST_LANDING = {
    ...
    'pos': {
        ...
        'auth_title': 'F&B that posts straight to the folio',
        'auth_lead': 'Sign in to take orders, fire KOTs, and bill to room.',
        'welcome_title': 'Outlet sign in',
        'welcome_lead': 'Open the POS for your restaurant or outlet',
        'register_title': 'Start Cloud POS',
        'register_lead': 'Touch-friendly billing linked to PMS folios',
        'auth_stats': [
            {'value': '1 folio', 'label': 'room + F&B'},
            {'value': 'Touch', 'label': 'outlet UI'},
            {'value': 'Multi', 'label': 'outlets'},
        ],
        'auth_bullets': [
            'Tables, dine-in, and room service',
            'Bill-to-room in one tap',
