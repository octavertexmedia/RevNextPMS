    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('widget_primary_color', models.CharField(default='#1B3A4B', max_length=20)),
                ('confirmation_email_enabled', models.BooleanField(default=True)),
                ('terms_url', models.URLField(blank=True)),
                ('success_message', models.CharField(blank=True, default='Thank you — your booking is confirmed.', max_length=255)),
                ('allowed_embed_origins', models.JSONField(blank=True, default=list, help_text='Origins allowed to embed the booking widget')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='channel_host',
            field=models.CharField(blank=True, help_text='Product host that created this booking, e.g. booking.revnext.in', max_length=100),
        ),
        migrations.AddField(
            model_name='directbooking',
            name='deposit_amount',
            field=djmoney.models.fields.MoneyField(blank=True, decimal_places=2, default_currency='INR', max_digits=14, null=True),
        ),
        migrations.AddField(
            model_name='directbooking',
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['session_key', 'expires_at'], name='booking_eng_session_893f80_idx'),
        ),
        migrations.AddIndex(
            model_name='directbooking',
            index=models.Index(fields=['property', 'status'], name='booking_eng_propert_babccb_idx'),
        ),
        migrations.AddIndex(
            model_name='directbooking',
            index=models.Index(fields=['confirmation_code'], name='booking_eng_confirm_98ad78_idx'),
        ),
        migrations.AddIndex(
            model_name='directbooking',
            index=models.Index(fields=['guest_email'], name='booking_eng_guest_e_b44bb5_idx'),
        ),
        migrations.AddField(
            model_name='bookingengineconfig',
            name='property',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='booking_engine_config', to='core.property'),
        ),
    ]
